      ...
      <div className="min-h-screen bg-slate-950 overflow-y-auto">
        <AntennaContractForm 
          ...
          initialData={ticket.contract ? {
            ...
            clientCategory: ticket.contract.clientCategory || "",
            planType: ticket.contract.planType || "",
            street: ticket.contract.street || "",
            houseNumber: ticket.contract.houseNumber || "",
            city: ticket.contract.city || "",
            province: ticket.contract.province || "",
            zipCode: ticket.contract.zipCode || "",
            terminalId: ticket.contract.terminalId || "",
            serialKit: ticket.contract.kitSerialNumber || "",
            downloadSpeed: ticket.contract.downloadSpeed?.toString() || "",
            uploadSpeed: ticket.contract.uploadSpeed?.toString() || "",
            latency: ticket.contract.latency?.toString() || "",
            networkMode: ticket.contract.networkMode || "",
            antennaLocation: ticket.contract.antennaLocation || "",
            antennaModel: ticket.contract.antennaModel || "",
            obstructions: ticket.contract.obstructions || "",
            obstructionObject: ticket.contract.obstructionObject || "",
            observations: ticket.contract.techNotes || "",
            perfObservations: ticket.contract.perfObservations || "",
            techName: ticket.contract.techName || "",
            techDni: ticket.contract.techDni || "",
            techSignedAt: ticket.contract.techSignedAt || null,
            clientSignedAt: ticket.contract.clientSignedAt || null,
            techSignature: ticket.contract.techSignature || "",
            clientSignature: ticket.contract.clientSignature || "",
            photoAntena: ticket.contract.photoAntena || "",
            photoSoporte: ticket.contract.photoSoporte || "",
            photoRouter: ticket.contract.photoRouter || "",
            photoTest: ticket.contract.photoTest || "",
            photoApp: ticket.contract.photoApp || "",
            photoRack: ticket.contract.photoRack || "",
          } : {
            clientName: "",
            clientEmail: "",
            clientDni: "",
