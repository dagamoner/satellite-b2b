  ...
  return (
    <AntennaContractForm 
      ...
      initialData={contractData ? {
        ...
        equipmentPrice: contractData.equipmentPrice,
        equipmentPaymentMethod: contractData.equipmentPaymentMethod,
        installationType: contractData.installationType,
        installationPrice: contractData.installationPrice,
        installationPaymentMethod: contractData.installationPaymentMethod,
