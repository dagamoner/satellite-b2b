              ...
              <AnimatePresence mode="wait">
                ...
                {mostrarPreciosB === 'capacitaciones' && (
                  ...
                  >
                    ...
                    {/* Selector de módulos */}
                    <div className="flex flex-col md:flex-row items-center justify-center gap-4 -mt-24 md:-mt-48 mb-0 w-full max-w-4xl mx-auto p-4 rounded-2xl bg-slate-900/60 border border-cyan-500/30 backdrop-blur-xl shadow-[0_0_30px_rgba(0,0,0,0.4)] relative z-10">
                    ...
                    {moduloSeleccionado && (
                      <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        className="w-full max-w-4xl mx-auto -mt-6 md:-mt-8 mb-2 relative z-10 px-4 md:px-0"
                      >
                        ...
                        <AnimatePresence mode="wait">
                          <motion.div
                            ...
                            transition={{ duration: 0.4, ease: "easeOut" }}
                            className="flex justify-center w-full mb-0"
                          >
                            <img
                              src={
                              ...
                              className="w-full max-w-sm md:max-w-md h-auto object-contain drop-shadow-[0_0_20px_rgba(51,232,255,0.4)] rounded-xl"
                              style={{ mixBlendMode: 'screen' }}
                            />
                          </motion.div>
                        </AnimatePresence>
