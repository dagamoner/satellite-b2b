  ...
  return (
    <div className="flex h-screen bg-[#020617] text-slate-300 overflow-hidden font-sans selection:bg-cyan-500/30 relative">
      ...
      <motion.aside 
        ...
        className="w-[28rem] border-r border-white/5 bg-slate-950/40 backdrop-blur-3xl flex flex-col shadow-2xl z-20"
      >
        <div className="p-8 border-b border-white/5 bg-gradient-to-b from-white/[0.02] to-transparent">
          ...
          >
            <motion.button 
              ...
              className={`col-span-2 text-[10px] font-black uppercase tracking-widest px-6 py-5 rounded-[1.8rem] border transition-all flex items-center justify-between group ${filterStatus === "OPEN" ? "bg-cyan-500 text-white border-cyan-400 shadow-[0_0_30px_rgba(6,182,212,0.3)] scale-[1.02]" : "bg-slate-900/40 text-slate-500 border-white/5 hover:border-white/10"}`}
            >
            ...
            {["CRITICAL", "HIGH", "MEDIUM", "LOW"].map((p) => {
              ...
              return (
                <motion.button
                  ...
                  className={`text-[9px] font-black uppercase tracking-widest p-5 rounded-[1.8rem] border transition-all flex flex-col gap-2 items-start group ${
                    isActive 
        ...
        {/* Navegación Rápida */}
        <div className="px-8 py-6 space-y-5 border-b border-white/5 bg-cyan-500/[0.02]">
          <div className="text-[9px] font-black text-cyan-500/50 uppercase tracking-[0.5em] mb-2 text-center">Módulos de Sistema</div>
          
          <div className="grid grid-cols-3 gap-4">
            <Link href="/contratos" className="flex flex-col items-center gap-2 group">
              <div className="w-10 h-10 bg-slate-900 border border-white/5 rounded-xl flex items-center justify-center group-hover:border-cyan-500/30 group-hover:bg-slate-800 transition-all">
                <svg className="w-5 h-5 text-slate-500 group-hover:text-cyan-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
              </div>
              <span className="text-[8px] font-black text-slate-600 uppercase tracking-widest group-hover:text-white">Auditoría</span>
            </Link>

            {(session?.user as { role?: string })?.role === "ADMIN" && (
              <>
                <Link href="/usuarios" className="flex flex-col items-center gap-2 group">
                  <div className="w-10 h-10 bg-slate-900 border border-white/5 rounded-xl flex items-center justify-center group-hover:border-cyan-500/30 group-hover:bg-slate-800 transition-all">
                    <svg className="w-5 h-5 text-slate-500 group-hover:text-cyan-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                  </div>
                  <span className="text-[8px] font-black text-slate-600 uppercase tracking-widest group-hover:text-white">Equipo</span>
                </Link>
                <Link href="/reportes" className="flex flex-col items-center gap-2 group relative">
                  <div className="absolute -inset-2 bg-cyan-500/10 blur-xl rounded-full opacity-0 group-hover:opacity-100 transition-opacity" />
                  <div className="w-10 h-10 bg-slate-900 border border-white/5 rounded-xl flex items-center justify-center group-hover:border-cyan-500/50 group-hover:bg-cyan-500/10 group-hover:shadow-[0_0_20px_rgba(6,182,212,0.2)] transition-all relative">
                    <svg className="w-5 h-5 text-slate-500 group-hover:text-cyan-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                    </svg>
                  </div>
                  <span className="text-[8px] font-black text-slate-600 uppercase tracking-widest group-hover:text-cyan-400 transition-colors">Intelligence</span>
                </Link>
              </>
            )}
          </div>
