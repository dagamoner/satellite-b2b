        ...
        <motion.div initial="hidden" animate="visible" variants={containerVariants} className="w-full max-w-md relative z-10">
          <Card variant="glass" className="p-10" hover={false}>
            <motion.div variants={itemVariants} className="flex flex-col items-center mb-10 text-center">
              <div className="mb-8">
                <h2 className="text-xl md:text-2xl font-bold text-cyan-400 tracking-widest uppercase drop-shadow-md">PORTAL NOC</h2>
              </div>
        ...
        <div className="max-w-[1600px] mx-auto px-4 md:px-8 py-3 md:h-24 flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-0">
          ...
          <div className="flex items-center gap-4 md:gap-8 overflow-x-auto no-scrollbar pb-1 md:pb-0 w-full md:w-auto">
            <div className="flex gap-1 bg-slate-900/50 p-1 rounded-xl border border-white/5 shrink-0">
                <a href={"https://www.mrtechnology.it.com"} className="px-3 md:px-4 py-2 text-[8px] md:text-[9px] font-black uppercase tracking-widest text-slate-500 hover:text-cyan-500 transition-colors border-r border-white/5 whitespace-nowrap">Web Principal</a>
