        ...
        <div className={`max-w-7xl mx-auto px-6 transition-all duration-500 flex items-center justify-between ${scrolled ? "h-20 md:h-24" : "h-32 md:h-44"}`}>
          ...
          >
             <div className="relative shrink-0">
               ...
               <img src="/Logo_new.png" alt="MR Technology" className={`rounded-xl border-2 border-slate-700 relative z-10 shadow-lg transition-all duration-500 ${scrolled ? "w-20 h-20 md:w-28 md:h-28" : "w-32 h-32 md:w-[280px] md:h-[280px]"}`} />
             </div>
