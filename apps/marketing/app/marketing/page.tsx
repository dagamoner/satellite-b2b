         ...
         <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
               ...
               <div className="bg-slate-900/50 p-8 rounded-2xl border border-slate-800">
                  ...
                  <h4 className="text-xl font-bold text-white mb-4">Centro Operativo (NOC & SOC)</h4>
                  <ul className="text-slate-400 text-sm space-y-3 font-medium">
                     <li>• Operador NOC / NOC Technician.</li>
                     <li>• Analista SOC (con foco estricto en redes).</li>
