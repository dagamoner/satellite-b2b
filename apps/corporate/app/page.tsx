...
const carouselClients = [
  ...
  { id: 11, src: "/L11_ANTARES.png", name: "ANTARES" },
  { id: 12, src: "/L12_LA_CAFETERIA_ARG.png", name: "CAFETERIA ARGENTINA" },
  { id: 13, src: "/L13_TUCSON.png", name: "TUCSON STEAK HOUSE" },
  { id: 14, src: "/L14_MINA_MEAT_HOUSE.png", name: "MINA MEAT HOUSE" },
  { id: 15, src: "/L15_REGATAS.png", name: "REGATAS" },
  { id: 16, src: "/L16_CASA_FARINA.png", name: "CASA FARINA" },
  { id: 17, src: "/L17_BELASCO_DE_BAQUEDANO.png", name: "BELASCO DE BAQUEDANO" },
  { id: 18, src: "/L18_EL_FARO_BISTRO.png", name: "EL FARO BISTRO" },
  { id: 19, src: "/L19_GAIA_EXPERIENCE.png", name: "GAIA EXPERIENCE" },
  { id: 20, src: "/L20_LA_ROCA.png", name: "LA ROCA" },
  { id: 21, src: "/L21_VICENTE.png", name: "VICENTE" },
  { id: 22, src: "/L22_ALOZ_SUSHI.png", name: "ALOZ SUSHI" },
  { id: 23, src: "/L23_LA_LUCIA.png", name: "LA LUCIA" },
...
export default function MarketingPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 dark:bg-[#020617] text-slate-900 dark:text-slate-50 font-sans selection:bg-cyan-500/30 overflow-x-hidden relative transition-colors duration-500">
      ...
      {/* ── FOOTER ── */}
      <footer className="relative z-10 pt-8 pb-12 px-4 border-t border-white/5 text-center flex flex-col items-center justify-center">
        <img
          src="/Logo WEB MR Tech.png"
          alt="MR Technology"
